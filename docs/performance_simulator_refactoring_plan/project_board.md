...
## Done
- [x] **CQ-BG-004** · Conv→GEMM 변환 및 ISA/워크로드 확장 — TE_CONV2D ISA 추가, Conv→GEMM 매퍼/테스트, 샘플 & 골든 자산(`workloads/cq/sample_conv.*`, `workloads/golden/cq_conv_single*`) 및 튜토리얼/CLI 문서 업데이트로 Accuracy Guard 경로까지 연동.
