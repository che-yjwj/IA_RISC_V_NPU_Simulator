...
- [x] **CQ-BG-003** · 자원/타이밍/경합 모델 구현 (`src/cq/models/*`, `src/simulator/main.py`, `src/cq/dispatcher.py`)
- [x] **CQ-BG-002** · ISA/CQ spec 기반 dataclass/codegen 파이프라인 도입 (`src/scripts/generate_cq_models.py`, `src/cq/generated/*`, `.githooks/pre-commit`, `src/cq/schema.py`, `src/cq/adapter.py`)
